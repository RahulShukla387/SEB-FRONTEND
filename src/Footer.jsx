...
>
  Grooming Personality
        ...
        <div className="  max-sm:ml-[8%]  grid lg:grid-cols-[0.1fr_2fr_2fr_2fr_2fr_0.1fr]    ">
            <div></div>
  <div className="">
    <img className=' lg:w-1/3 , max-xs: w-1/6 max-sm:w-1/6 ' src="\images\seblogo-removebg-preview.png" alt="" />
