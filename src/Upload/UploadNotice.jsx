...
useEffect(() => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <form onSubmit={handleUpload} className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold text-center mb-6 text-gray-800">
          Admin Upload
        </h2>

        <label className="block text-gray-700 font-semibold mb-2">Notice Title</label>
        <input
          type="text"
          placeholder="Enter notice title"
          value={title}
